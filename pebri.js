...
Ketik ${prefix}verify untuk memulai menggunakan bot.`
			...
			console.log('EROR TOLOL : %s', color(e, 'red'))
		}
	})
...
//-- watermark stiker
			function addMetadata(packname, author) {	
				if (!packname) packname = 'Hisiron BOT'; if (!author) author = pushname ;	
...
//-- owner bot
case 'owner':
    nomor = '6281279278674@s.whatsapp.net'
    owner = await fs.readFileSync('./docs/pebz.jpeg').toString('base64')
    capt = "𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿\nIG : Hisiron BOT\nWhatsapp BOT : HISIRON BOT"
    const been = {
